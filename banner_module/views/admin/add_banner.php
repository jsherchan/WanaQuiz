	  ...
	  <table width="95%" border="0" cellspacing="1" cellpadding="4" >
		  ...
		  <tr> 
			...
			<select name="banner_location">
				<option value="1" />Free Bid Every Day Banner(694 width* 65 height)</option>
				<option value="2" >Join Us And win Banner(260 width* 116 height)</option>
				<option value="3" />Refer To Friend Banner(244 width* 54 height)</option>
				<option value="4" >Video Instruction Banner(260 width* 200 height)</option>
			</select>
