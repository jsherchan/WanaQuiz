                        ...
                        <div class="longwhitebox_topborder">
                            <div class="title_align">
                                ...
                                <div class="bluetitlebg_bg" style="width:770px;">
                                    <div class="bold font14 color_white">View All Photo Questions</div>
                                </div>
                                        ...
                                        <div class="content_10box">
                                            ...
                                            <div class="content_wrap">
                                            	<div class="padding_2bottom">
                                                    <div>
                                                    	<div class="bold">
                                                        	<div class="msg_checkbox"><input type="checkbox" name="allbox" onclick="checkAll()" value="on"/></div>
                                                        	
                                                                <div class="addoptional_desc"><a href="#" >Check All</a> &nbsp;&nbsp;&nbsp; <a href="#" id="delete_all">Delete All</a><?php if($type=='video')$add_question='addVideoQuestion'; else $add_question = 'addPhotoQuestion';?><a href="<?=base_url()?>member/<?=$add_question?>" style="margin-left:20px">Add new question</a></div>
                                                ...
                                                <div class="padding_2bottom">
                                                    <div class="bg_blue">
                                                    	<div class="bold">
                                                        	...
                                                        	<div class="viewimg">Image/Video</div>
                                                    ...
                                                    <div class="bg_lightblue">
                                                        <div>
                                                            <div class="msg_checkbox">
                                                                <input type="checkbox" name="mailid[]" value="<?=$question->quiz_id?>" />
                                                            </div>
