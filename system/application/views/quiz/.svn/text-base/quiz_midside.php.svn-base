...
var subcat_id;
    function showPhotoAgain(){        
        var htm = '';
        htm += '<div id="<?=$con?>" style="width:100%;">';
        htm += '<div id="<?=$bg?>_" class="game_bg2">';
            htm += '<div class="content_10box" style="padding:0px">';
                htm += '<div class="content_wrap" align="center">';
                    ...
                    htm += '<div class="<?=$txt?>" style="display:none" id="textimgalign"><div class="textimg" id="question"></div></div>';
                htm += '</div>';
           htm += '</div>';
        htm += '</div>';
        htm += '</div>';
...
//        $.post('<?=base_url()?>quiz/showAnswerResult', {quiz_id:3} , function(data){ alert(data); });return false; 
$.scrollTo('.quiz_midside', 800);
//$.scrollTo('-=42px');
                    ...
                    <div class="content_10box" style="padding-top:0; margin-top:0px;">
                        <div class="content_wrap">
                            ...
                            <? if($quiz_info->quiz_type=="video") {?>
                                <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" WIDTH="500" HEIGHT="343" id="banner_rotativo" ALIGN="">
                                        ...
                                        <div class="padding_10topbottom">
                                            <div class="quizhelp_links">
                                                <ol style="padding-left:24px;">
                                                    ...
                                                    <li>Answer questions from just<a href="<?php echo site_url("home/show/all_questions")?>"> one person</a></li>
                                                    <li>Design your own<a href="<?php echo site_url('gameboard ')?>"> free game board</a> and play against your family/friends.</li>
                                                </ol><br />
                                                <span><a href="<?php echo site_url('home/show/single_player_game ')?>">Read more</a></span>
                                            </div>
                                        </div>
                                    </div>
