		...
		new AjaxUpload(button2, {
			...
			onComplete: function(file, response){
				...
				// add file to the list
                                //alert('<img src="<?=base_url()?>advertiser_banners/advertiser_banner_thumbs/'+respone);
                                 //var image=base64_encode('advertiser_banners/'+file);
				$('#banner_preview_2').html( '<img src="<?=base_url()?>advertiser_banners/advertiser_banner_thumbs/'+respArr[0]+'"  alt='+errorimg+' width="170px" height="365px" />' );
			}
		});
            ...
            <div class="quizmaking_bg">
            	<div class="whiteboxrightside_bgInner">
                    ...
                    <?php if($edit==0)
                            ...
                            ?>
                    <form name="add_advertiser_video_question" action="<?=$action?>" method="post" enctype="multipart/form-data">
                    <div class="content_10box">
                    	<div class="padding_10leftright">
                            ...
                            <div class="content_wrap">
                                ...
                                <div class="quizvideo_bg">
                                    ...
                                    <div class="content_10box">
                                        	...
                                        	Your banner will be displayed next your question (and answer). Below you can select up to four banners to rotate beside your question
                                                                        ...
                                                                        <div class="textadsbox_right">
                                                                        	<div class="textadsform">
                                                                            	<div class="input_clear">
                                                                                    ...
                                                                                    <input type="text" id="long_text_ads_title_<?=$i?>" name="long_text_ads_title_<?=$i?>" class="textbox" style="width:215px;" value="<?php echo $long_text_info[$i]->link_title;?>" />
                                                                                ...
                                                                                <div class="input_clear">
                                                                                	<label>Your text ad (non clickable) : <?php if($i<1){ ?>(not more than 100 characters)<? } ?></label>
                                                                                    <textarea  id="long_text_ads_description_<?=$i?>" name="long_text_ads_description_<?=$i?>" style="width:215px; height:80px;" class="textbox"><?php echo $long_text_info[$i]->link_description;?></textarea>
                                                                                ...
                                                                                <div class="input_clear">
                                                                                    ...
                                                                                    <input type="text" id="long_text_ads_url_<?=$i?>" name="long_text_ads_url_<?=$i?>" class="textbox" style="width:215px;" value="<?php echo $long_text_info[$i]->link_url;?>" />
                                    ...
                                    <div class="content_wrap">
                                        ...
                                        <div class="quizvideo_bg">
                                            ...
                                            <div class="content_10box">
                                            	<div class="content_wrap">
                                                	<div>
                                                    	After an user sees the answer to your question our software will create a thumbnail of your question (photo or video) and displays it in the player. The text that accompanies your thumbnail is: "Offer from publisher of last question:". Below you can enter up to 5 text ads (offers) beside your thumbnail.
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <div class="textadsbox_right">
                                                                        	<div class="textadsform">
                                                                                ...
                                                                                <div class="input_clear">
                                                                                    ...
                                                                                    <textarea id="short_text_ads_descrption_<?=$i?>" name="short_text_ads_descrption_<?=$i?>" style="width:215px; height:80px;" class="textbox"><?php echo $short_text_info[$i]->link_short_desc;?></textarea>
																				...
																				<div class="input_clear">
                                                                                    ...
                                                                                    <input type="text" id="link_url_<?=$i?>" name="link_url_<?=$i?>" class="textbox" size="45" value="<?php echo $short_text_info[$i]->link_url;?>"/>
