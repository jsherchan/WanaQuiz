                                ...
                                <div class="content_10box">
                                    ...
                                    <div class="content_wrap">
                                        ...
                                        else 
                                        {
                                            ...
                                            <p align="right"> <?=$this->pagination->create_links();?></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="content_wrap">
                                        ...
                                        <div id="list">
                                            ...
                                            {      
                                                ...
                                                {   
                                                    if($user_id && $ids && $this->Quiz_model->check_similar_quiz($ids,$answers,$video_result_data->quiz_id,$video_result_data->user_id))
                                                        continue;
                                                    ?>
