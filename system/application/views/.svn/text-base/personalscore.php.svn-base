	...
	<div class="bodywrapInner">
        <div class="home_leftside">
            <div>
                ...
                <?php include('includes/personalscore_midside.php'); ?>
        
                <div class="clear"></div>
            </div>
            
            <?php include('includes/personalscore_bottombox.php'); ?>
            
        </div>
        
        <?php include('includes/personalscore_rightside.php'); ?>
