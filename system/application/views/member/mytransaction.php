                            ...
                            <div class="whiteboxrightside_bgInner">
                            	...
                            	<div class="content_10box">
                                	<div class="padding_10topbottom">
                                        	...
                                        	<div class="">
                                                    ...
                                                    <select style="width:180px;" onChange="submit_playlist()" name="select_playlist">
                                                        ...
                                                        <?php if($playlist)
                                                        {
                                                            ...
                                                            <option value="<?=$play_list->id?>"><?=$play_list->playlist_title?></option>
                                                            <? }}?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="clear"></div>
                                    </div><?php //print_r($playlist_quizes);?>
                                    	...
                                    	<div class="bg_blue">
                                            	...
                                            	<div class="playlistcontent_left">
                                                    ...
                                                    <div class="playbtn">
                                                        <a href="<?=base_url()?>quiz/view/<?=$quiz_detail[0]->quiz_id?>">
                                                             <img src="<?=base_url()?>photo_question_thumbs/<?=$quiz_detail[0]->images?>" width="94" height="71" alt="song img"/>
                                                        </a>
                                                    </div>
                                                   <?php } else { ?>
                                                ...
                                                flowplayer("player_<?=$quiz_detail[0]->quiz_id?>", "flowplayer/flowplayer-3.1.5.swf",{
                                                    ...
                                                    <div class="playlistdetail">
                                                    	<div class="playlistdetailInner">
                                                            <div class="bold"><a href="<?=base_url()?>quiz/view/<?=$quiz_detail[0]->quiz_id?>"><?=$quiz_detail[0]->quiz_question;?></a></div>
                                                	...
                                                	<div>
                                                        ...
                                                        <div class="general_form">
                                                            <div class="input_clear">
                                                                ...
                                                                <input type="text" class="textbox" value="<?=base_url()?>quiz/view/<?=$quiz_detail[0]->quiz_id?>" onfocus="this.select()" readonly="readonly"/>
                                                            </div>
                                                            <div class="input_clear">
                                            ...
                                            <div class="content_10box">
                                            	<div class="playlistcontent_left">
                                                    ...
                                                    <div class="graybtn_leftborder"></div>
                                                    <div class="graybtn_bg"><a href="#" onclick="delete_playlist_quiz(<?=$playlistQuizes->quiz_id?>)">Delete Playlist</a></div>
                                                    <div class="graybtn_rightborder"></div>
                                                </div>
                                            	<div class="playlistcontent_right">
                                                	<div class="playicons_align">
                                                    	<div class="play_icon"><a href="<?=base_url()?>quiz/view/<?=$quiz_detail[0]->quiz_id?>">Play </a></div>
                                                        <div class="share_icon">
                                                             <span class="st_sharethis" displayText="Share this Quiz"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <? } } } else echo "There is no any quizes in this playlist!";?>
                                   <!-- <div class="padding_10topbottom">
                                    	<div class="playlistcontent_left">
                                        	<div class="searchbtn_leftborder"></div>
