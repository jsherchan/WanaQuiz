                ...
                <div class="content_wrap">
                    <div class="whiteboxrightside_topborder1">
                        <div class="title_align">
                            <div class="font14 bold">Your Advertisement</div>
                        </div>
                    </div>
                        ...
                        <div class="whiteboxrightside_bgInner">
                        	<div class="add_links">
                                <ul>
                                    ...
                                    <li><a href="<?=site_url('member/buyAdSpace')?>">Buy Views and Clicks</a></li>
<!--                                    <li><a href="javascript:switchit('create')">Let our professionals create Your banners</a>
                                    	<ul id="create">
                                        	<li><a href="<?//=site_url('member/professionalCreate/professional_create_question')?>">Your questions</a></li>
                                            <li><a href="<?//s=site_url('home/show/banners')?>">Your banners</a></li>
                                        </ul>
                                    </li>-->
                                    <li>
                                        <a href="<?=site_url('home/show/banners')?>">Let our professionals create Your banners</a>
                                    </li>
                                    <li><a href="<?php echo site_url('home/show/budget')?> ">Options for larger campaigns</a></li>
                                    <!--<li><a href="<?=site_url('member/embedPlayer')?>">Embed a player</a></li>-->
                                    <li><a href="<?=base_url()?>home/help_center/faq">FAQ</a></li>
                    ...
                    <div class="whiteboxrightside_bg">
                        <div class="whiteboxrightside_bgInner">
                            <div class="padding_10top">
                                <div class="borderbottom_dotted"></div>
                                <?php
                                //print_r($recently_played);
                                if(count($recently_played)>0){

                                foreach($recently_played as $played_quizes) { ?>

                                <div class="content_10box">
                                    <div><a href="<?=site_url('quiz/views/'.$played_quizes->quiz_id)?>"><?=$played_quizes->quiz_question;?> </a></div>
                                    <div class="padding_10top">
                                        ...
                                        <div class="featuredquest_right">
                                        	<div>
                                                ...
                                                <div class="padding_5top">Views: <?php echo $this->Quiz_model->get_quiz_views($played_quizes->quiz_id)?> </div>
                    ...
                    <div class="whiteboxrightside_bg">
                        <div class="whiteboxrightside_bgInner">
                            <div class="padding_10top">
                                    ...
                                    <div class="padding_10top">
...
#else $photo_path1 = $_SERVER['DOCUMENT_ROOT']."/clients/wannaquiz/photo_question_thumbs/".$unplayed_quizes->images;
...
#else $b = $_SERVER['DOCUMENT_ROOT']."/clients/wannaquiz/converted_video_images/converted_video_images_thumbs/".$unplayed_video_image;
                                        ...
                                        <div class="featuredquest_right">
                                        	<div>
                                                ...
                                                <div class="padding_5top">Views: <?php echo $this->Quiz_model->get_quiz_views($unplayed_quizes->quiz_id)?> </div>
                                                <div class="padding_5top">
                                                    <div class="padding_5top">
                                                    <!-- Rating Stars -->
                                ...
                                <div class="borderbottom_dotted"></div>
                                <?php } } else {?>
                                <div class="content_10box" style="padding-left: 10px;">There is no quiz!</div>
                                <? }?>
