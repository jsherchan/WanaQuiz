...
{    
    ...
    if(checked_radio == 'user_credits')
    {
        ...
        var user_credit = <?=($mem_info->user_credits>0) ? $mem_info->user_credits : 0?>;
        if(user_credit == '') user_credit = 0;
        user_credit += remaining_budget;
        ...
        {
            $.prompt("You don't have enough credits . Redirect to PayPal for purchase ?",{ buttons: { Ok: true, Cancel: false },callback: function(v,m,f){
                        if(v){
                        ...
                        <div class="whiteboxmidside_bg">
                            <div class="whiteboxrightside_bgInner">
                                ...
                                <!--div class="content_10box">
                                    ...
                                    <div class="padding_10topbottom">
                                        <div class="font14 bold">&nbsp;&nbsp;&nbsp;Total Remaining Balance : $ <?php if($quiz_budget_details->remaining_budget) echo $quiz_budget_details->remaining_budget; else echo '0'; ?> </div>
                                    </div>                                    
                                    <div class="padding_10topbottom">
                                        	...
                                        	<div class="general_form">                                            	
                                                <div class="input_clear">
                                                	<label>Buy Clicks</label>
                                                        ...
                                                        <?php if($mem_info->user_credits > 0) { ?>
