                            ...
                            <div class="regbox_bg">
                            	<div class="content_10box">
                                    ...
                                    <div class="padding_10topbottom">
                                    	<form name="signup" action="<?=site_url('registration/regular')?>" method="post">
                                        	<div class="general_form">
                                                    ...
                                                    <div class="input_clear">
                                                      ...
                                                      <div class="input_clear">
                                                        ...
                                                        <select name="gender">
                                                            <option id="male" value="male" <?php echo set_select('gender','male')?>>Male</option>
                                                            <option id="female" value="female" <?php echo set_select('gender','female')?>>Female</option>
                                                        </select>
                                            ...
                                            <div class="signupbtn_align">
                                            	<div class="general_formcheckbox">
                                                	<div class="input_clear">
                                                        ...
                                                        <label style="width:535px;">I agree to the terms outlined in <a href="<?=base_url()?>">WannaQuiz's</a> <a href="<?=base_url()?>page/show/terms_conditions" class="color_lightblue">Conditions</a> of Use</label>
