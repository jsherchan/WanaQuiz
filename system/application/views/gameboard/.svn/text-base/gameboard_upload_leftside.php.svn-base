                        ...
                        <div class="content_10box">
                            ...
                            <div class="content_wrap">
                                    	...
                                    	<div class="content_wrap">
                                            <div class="border_gray">
                                                <div class="content_5box">
                                                    <div class="color_lightblue bold"><?php if($type == 'free')echo 'Free game boards'; else echo 'Premium Gameboard'; ?></div>
                                                    <div class="content_10box">
                                ...
                                <div class="gameboard_right">
                                    ...
                                    <div>
                                    	<!--<form name="uploadgameframe" action="<?=site_url('gameboard/customizedGameboard')?>" method="post" enctype="multipart/form-data">-->
                                        <form name="uploadgameframe" action="<?=site_url('gameboard/Gameboard_image_preview')?>" method="post" enctype="multipart/form-data">
