                                                ...
                                                <div class="gameboardbox_bgalign">
                                                    <div class="text_center">
                                                            ...
                                                            <div class="gameboardbox_bg">
                                                            	<div class="gameboardbox_bgInner" >
                                                                    ...
                                                                    <a href="#"  style="display:block; background:url(<?=base_url()?>gameboard_thumb_images/<?=$premiumBoards->board_image?>) no-repeat top left; width:158px; height:158px; margin-top:-20px; margin-left:-20px">
                                                                         <img src="<?=base_url()?>gameboard_thumb_images/<?=$user_image?>" style="width:108px; height:108px; margin-top:25px"></img>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="premium_btn_align">
                                                            ...
                                                            <div class="premium_btn"><a href="javascript:void(0);" style="background-color:#999999;" onclick="print_board('<?=$premiumBoards->board_image;?>','print','<?=$i?>')" id="printboard_<?=$i?>">Preview</a></div>
       ...
       // alert(body_height);
        $.ajaxSetup({ cache: false });
         $.ajax({
               ...
               cache : false,
               data: "board_name="+board_name+"&image=<?=$image?>",
