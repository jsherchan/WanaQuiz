...
<form action="<? echo site_url(ADMIN_PATH.'/news/insert_data');?>" method="Post" name="frm_cms">
<tr>
...
<option value="ebid">Ebid News</option>
...
<tr>
<td> 
<input size="60" class="inputtext" type="text" id="news_title" name="news_title" value=""></td>
</tr>
...
<tr>
<td > 
  <textarea name="news_description" cols="70" rows="20"></textarea>
</td>
</tr>

<tr>
<td > 
 <input type="radio" name="status" value="1" checked="checked"/> Save & Publish 
  <input type="radio" name="status" value="0" /> Save as draft 
</td>
</tr>

<tr height=25 valign="middle">
<td><input type="submit" name="submit" value="Submit" class="bttn" onClick="submitForm();" ></td>
</tr>
</form>
</table>
