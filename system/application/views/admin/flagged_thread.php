...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="86%" height="40"> <span class="header"><a href="<?=site_url(ADMIN_PATH.'/home/')?>">ADMIN</a>
                >><a href="<?=site_url(ADMIN_PATH.'/moderator_activities/')?>"> Moderator Activities </a>>>Flagged Forum Posts</span></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ttable">
    <tr>
        ...
        <? 
        $j=1;
        if(count($flagged_thread)!=0){
              foreach($flagged_thread as $rows) 
                   {
