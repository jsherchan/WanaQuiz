...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="86%" height="40"><span class="header"><a href="<?=site_url(ADMIN_PATH.'/admin')?>">ADMIN</a> >><a href="<?=site_url(ADMIN_PATH.'/banner_management/textAds')?>"> Text Ads Management</a> >> Add Text
            </span></td>
...
<table width="100%"  border="0">
    <tr>
        <td width="17%" >[ <a href="<?=site_url(ADMIN_PATH.'/banner_management/textAds')?>"><strong> VIEW TEXT LIST </strong></a>]</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <td colspan="2">
        ...
        <form name="frm_banner" method="post" enctype="multipart/form-data"  action="<?=site_url(ADMIN_PATH.'/banner_management/insert_text_ads/')?>" onSubmit="return submitForm('');" >
                        ...
                        <table width="95%" border="0" cellspacing="1" cellpadding="4" >
                            <tr>
                                ...
                                <td width="75%" align="left" valign="middle" class="cat_block1">
                                    <input name="text_name" type="text" class="comment" value="" size="50"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" valign="middle" class="title_content_block">
                                    <textarea name="content" type="text" id="content" rows="5" cols="29"></textarea><br />
                                </td>
                            </tr>
