...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="86%" height="40"> <span class="header"><a href="<?=site_url(ADMIN_PATH.'/home/')?>">ADMIN</a>
                >><a href="<?=site_url(ADMIN_PATH.'/moderator_activities/')?>"> Moderator Activities </a>>>Activity by : <a href="<?=base_url()?><?=$moderator_list[0]->username?>"><?=$moderator_list[0]->username?></a></span></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ttable">
    <tr>
        ...
        if(count($moderator_list)!=0){
              foreach($moderator_list as $rows) 
                   {
