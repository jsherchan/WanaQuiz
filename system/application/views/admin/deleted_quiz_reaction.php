...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="86%" height="40"> <span class="header"><a href="<?=site_url(ADMIN_PATH.'/home/')?>">ADMIN</a>
                >><a href="<?=site_url(ADMIN_PATH.'/moderator_activities/')?>"> Moderator Activities </a>>>Deleted Text Reactions</span></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ttable">
    <tr>
      ...
      <tr>
        ...
        <td align="left"><a href="<?=base_url()?>quiz/view/<?=$rows->item_id?>"><?=$rows->comment?></a></td>
