...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="22%" ><strong>[ <a href="<?=site_url(ADMIN_PATH.'/newsletter/addnewsletter')?>" style="color:#003399"> +Add New Newsletters </a> ]</strong></td>
	
	<td width="25%" align="right"><strong>[ <? if($flag=='Draft') {?>Draft Newsletters<? } else {?><a href="<?=site_url(ADMIN_PATH.'/newsletter/viewnewsletter/Draft')?>" style="color:#003399">View Draft Newsletters </a> <? }?>]</strong></td>
	
	<td width="30%" align="right"><strong>[ <? if($flag=='Sent') {?>Sent Newsletters<? } else {?><a href="<?=site_url(ADMIN_PATH.'/newsletter/viewnewsletter/Sent')?>" style="color:#003399">View Sent Newsletters </a><? }?> ]</strong></td>
	
	<td width="23%" align="right"><strong>[ <a href="<?=site_url(ADMIN_PATH.'/newsletter/mailingGroups/subscribers')?>" style="color:#003399">Mailing List Groups </a>]</strong></td>
	</tr>
