...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="86%" height="40"><span class="header"><a href="<?=site_url(ADMIN_PATH.'/admin')?>">ADMIN</a> >><a href="<?=site_url(ADMIN_PATH.'/score_badge_management/quiz_bonus_points')?>"> Quiz Bonus Point Management</a> >> Add Quiz Bonus Point
	 </span></td>
...
<form name="frm_banner" method="post" action="<?=site_url(ADMIN_PATH.'/score_badge_management/insert_quiz_bonus_point/')?>">
    ...
    <tr> 
	  ...
	  <table width="95%" border="0" cellspacing="1" cellpadding="4">
          <tr> 
			...
			<input name="question_answered_in_row" type="text" class="comment" value="" size="5"></td>
          </tr>
          
           <tr>
            <td width="25%" align="right" valign="middle" class="cat_block1">Quiz Difficult Level<span class="style1">*</span></td>
            <td width="75%" align="left" valign="middle" class="cat_block1">
