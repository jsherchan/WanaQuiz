...
<table width="100%"  border="0">
  <tr>
    <td width="17%" >[ <a href="<?=site_url(ADMIN_PATH.'/members/member_cpc')?>"><strong> Member CPC </strong></a>]</td>
...
<form name="frm_banner" method="post" enctype="multipart/form-data"  action="<?=site_url(ADMIN_PATH.'/members/update_member_cpc/')?>" onSubmit="return submitForm('');" >
