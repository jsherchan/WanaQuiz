...
<table align=left cellpadding=2 cellspacing=0 width=99% border="0" class="light">
    <form action="<?php if(!isset($add)) echo site_url(ADMIN_PATH.'/content_help_question_management/edit/'); else echo site_url(ADMIN_PATH.'/content_help_question_management/add/');?>" method="Post" name="form">
        <tr>
        ...
        <tr>
            <td>
                ...
                ( Add quiz_id at the last of url. eg. http://sitename/home/content/20 )
            </td>
