<h2 class="headingclass" >Levels Management </h2>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="86%" height="40"><span class="header"><a href="<?=site_url(ADMIN_PATH.'/admin')?>">ADMIN</a> >><a href="<?=site_url(ADMIN_PATH.'/score_badge_management/add_levels')?>"> Levels Management</a> >> Add levels
	 </span></td>
...
<table width="100%"  border="0">
  <tr>
    <td width="34%" >[ <a href="<?=site_url(ADMIN_PATH.'/score_badge_management/levels')?>"><strong> View Levels </strong></a>]</td>
...
<form name="frm_banner" method="post" enctype="multipart/form-data"  action="<?=site_url(ADMIN_PATH.'/score_badge_management/insertLevels/')?>">
    ...
    <tr> 
	  ...
	  <table width="95%" border="0" cellspacing="1" cellpadding="4" >
          <tr> 
			...
			<input name="level_name" type="text" class="comment" value="" size="50"></td>
          </tr>

          <tr>
            <td width="25%" align="right" valign="middle" class="cat_block1">Points<span class="style1">*</span></td>
            <td width="75%" align="left" valign="middle" class="cat_block1">
			<input name="points" type="text" class="comment" value="" size="50"></td>
          </tr>
