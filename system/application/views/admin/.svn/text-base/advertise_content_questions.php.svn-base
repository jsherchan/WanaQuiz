...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="86%" height="40"> <span class="header"><a href="<?=site_url(ADMIN_PATH.'/home')?>">ADMIN</a> >>Advertise content management</span></td>
...
<a href="<?=site_url(ADMIN_PATH.'/advertise_content_management/addContentQuestion/')?>">	[ + ADD PAGE]</a>
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ttable">
      <tr>
        ...
        <th width="30%" align="left"><div align="left">
      ...
      <tr>
		...
		<td align="center"><a href="<?=site_url(ADMIN_PATH.'/advertise_content_management/deleteQuestion/'.$rows->id)?>"><img src='<?=base_url()?>images/admin_images/delete.gif' alt="Delete Content" onclick="return doconfirm()"></a></td>
		<td align="center"><a href="<?=site_url(ADMIN_PATH.'/advertise_content_management/editContentQuestion/'.$rows->id)?>"><img src='<?=base_url()?>images/admin_images/edit.gif' alt="Edit Content"></a></td>		
      </tr>
