...
<form name="form1" method="post"   action="<? if(!isset($add_states)) { echo site_url(ADMIN_PATH.'/country_management/update_states/'); } else echo site_url(ADMIN_PATH.'/country_management/insert_states/');?>" onsubmit="return verify_form(this);">
  <table width="60%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#999999">
    <tr> 
      <td align="center" valign="top" bgcolor="#FFFFFF"><table width="95%" border="0" cellspacing="1" cellpadding="1">
          ...
          <tr> 
            <td align="left" valign="middle" class="content">State Name:<span class="style1">*</span></td>
            <td align="left" valign="middle">
			<?php if(!isset($add_states)) {?><input name="state_id" type="hidden" value="<?=$state_info[0]['state_id']?>" size="30" maxlength="30"><?php }?>
			<input name="country_id" type="hidden" value="<?=$country_info[0]['country_id']?>" size="30" maxlength="30">
			<input name="state_name" type="text" class="comment" id="state_name" value="<?  if(!isset($add_states)) { echo $state_info[0]['state_name']; }?>" size="30" maxlength="30"></td>
          </tr>
          <tr>
            <td align="left" valign="middle" class="content">State Code:<span class="style1">*</span></td>
            <td align="left" valign="middle"><input name="state_code" type="text" class="comment" id="state_code" value="<?  if(!isset($add_states)) { echo $state_info[0]['state_code']; }?>" size="30" maxlength="30"></td>
