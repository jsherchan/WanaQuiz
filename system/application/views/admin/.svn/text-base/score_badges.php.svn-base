...
<table width="100%" border="0" cellspacing="0">
	<tr>
		<td width="20%">
        <strong> <a href="<?=site_url(ADMIN_PATH.'/score_badge_management/add_score_badge')?>" style="color:#003399">[+ ADD Badge and Level]</a></strong>
		</td>
        ...
        <td width="20%">
            <strong> <a href="<?=site_url(ADMIN_PATH.'/score_badge_management/getLevels')?>" style="color:#003399">[Level Management ]</a></strong>
	</td>
...
<?php if(count($score_badge_list)>0){
foreach($score_badge_list as $rows){
?>  
