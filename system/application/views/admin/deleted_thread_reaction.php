...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="86%" height="40"> <span class="header"><a href="<?=site_url(ADMIN_PATH.'/home/')?>">ADMIN</a>
                >><a href="<?=site_url(ADMIN_PATH.'/moderator_activities/')?>"> Moderator Activities </a>>>Deleted Forum Reactions</span></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" class="ttable">
    <tr>
        ...
        <th width="111" align="center"> <a href="#" style="color:#FFFFFF">Posts </a></th>
