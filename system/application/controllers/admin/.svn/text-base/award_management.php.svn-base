...
class Award_management extends Controller {

	function Award_management()
	{
		parent::Controller();	
        $this->load->model('Award_management_model');
     }
	...
	function getAwards(){
		...
		$data['award_list']=$this->Award_management_model->get_award_list();
	...
	$score_badge_info=$this->Score_badge_management_model->get_score_badge_info($this->input->post('id',TRUE));
