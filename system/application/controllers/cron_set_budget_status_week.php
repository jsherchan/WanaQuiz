<?php 
class Cron_set_budget_status_week extends Front_controller {
 ...
 * @access	public
 */
    function Cron_set_budget_status_week() {
    ...
    function index(){
        $this->setQuizBudgetStatusWeek();
    }

    function setQuizBudgetStatusWeek(){
        $sql = "select * from tbl_quiz_budgets where budget_status='0' and per_selection = 'week'";
