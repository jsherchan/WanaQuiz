...
{		
	$defaults = array('word' => '', 'img_path' => '', 'img_url' => '', 'img_width' => '200', 'img_height' => '80', 'font_path' => '', 'expiration' => 7200);		
   ...
   if ($word == '')
   {
	...
	$x_axis	= 20;//rand(6, (360/$length)-16);			
	...
	$text_color		= imagecolorallocate ($im, 10, 50, 50);
	$grid_color		= imagecolorallocate($im, 200, 182, 182);
