...
array (                                                                       
            'value'       => '/sunil/ebid/gallery/',  //  '/demo1client/digmywork.com/gallery/',                                           
            'text'        => 'Site Pictures',
        )
   	 );
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir']        = array('/sunil/ebid/gallery/');		    // image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	//$cfg['base_url']     = 'http://www.shoeseat.com/bidsoft/';
