...
#xit;
        ...
        $current_date = $this->current_date_time_stamp();
    ...
    function current_date_time_stamp()
{
	...
	//$site_info=$CI->Site_setting_model->get_site_info(1);
        $query="SELECT * FROM tbl_site_settings WHERE site_id='1'";
	$res = mysql_query($query);
        $site_info = mysql_fetch_assoc($res);
